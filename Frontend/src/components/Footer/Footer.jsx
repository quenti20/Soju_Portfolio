          ...
          <div className="sm:col-span-2">
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-xl font-semibold">
                <span className="text-white">Soujanya</span>
                <span className="bg-gradient-to-r from-violet-400 to-purple-400 bg-clip-text text-transparent ml-1">Roy</span>
              </span>
            </div>
            <p className="text-zinc-400 mb-6 max-w-sm leading-relaxed">
              Professional Animator & UI/UX Designer crafting digital experiences through motion and design.
            </p>
